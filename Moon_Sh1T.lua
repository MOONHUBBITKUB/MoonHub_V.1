if game:GetService("CoreGui"):FindFirstChild("Ripple") then
	game.Players.LocalPlayer:kick("อย่ารันเกิน1รอบ")
end
...
MODILEMAGE.Image = "https://www.roblox.com/library/11473710942/1667650492632"
wait(1)
...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Moon hub free script') then
        makefolder('Moon hub free script')
    end
    if not _G.Dis and not isfile('Moon hub free script/'..Name..'.json') then
        writefile('Moon hub free script/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Moon hub free script') and isfile('Switch Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Moon hub free script/'..Name..'.json'))
...
function Text(value)
    game.StarterGui:SetCore("SendNotification", {
        Title = "Moon Notification", 
        Text = tostring(value),
        Icon = "https://www.roblox.com/library/11473617938/54-454631B",
        Duration = 10
    })
end
function Com()
...
local win = library:Window("Moon",[[Hub]],[[Version : V.1.0.0]],"",Enum.KeyCode.RightControl)
